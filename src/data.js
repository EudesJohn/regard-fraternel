...
export const programmes = [
  {
    ...
    cle: 'sanitaire',
    numero: '01',
    titre: 'Appui sanitaire',
    sousTitre: 'Accès aux soins & santé communautaire',
    texte: "L'ONG REGARD FRATERNEL agit pour l'accès aux soins de santé des populations vulnérables : campagnes de sensibilisation, soutien aux structures sanitaires et accompagnement des communautés dans la prévention et la prise en charge.",
    stats: [
      { valeur: '3', label: 'Actions documentées' },
      { valeur: '100%', label: 'Bénéficiaires communautaires' }
    ],
    photos: 'sanitaire'
  },
  {
    ...
    cle: 'scolaire',
    numero: '02',
    titre: 'Appui scolaire',
    sousTitre: 'Éducation & réussite des enfants',
    texte: "La scolarisation et la réussite éducative sont au cœur de notre combat contre la déscolarisation. Nous appuyons les écoles, fournissons du matériel didactique et accompagnons les élèves dans leur parcours.",
    stats: [
      { valeur: '45', label: 'Photos d’actions' },
      { valeur: '+200', label: 'Élèves bénéficiaires' }
    ],
    photos: 'scolaire'
  },
  {
    ...
    cle: 'jeux',
    numero: '03',
    titre: 'Espaces de jeux & loisirs',
    sousTitre: 'Épanouissement des enfants',
    texte: "Des balançoires et des aires de jeux pour le droit des enfants à l'épanouissement, au jeu et au loisir — un cadre essentiel à leur développement physique et social.",
    stats: [
      { valeur: '5', label: 'Photos documentées' },
      { valeur: '1', label: 'Espace aménagé' }
    ],
    photos: 'jeux'
  },
  {
    ...
    cle: 'donEcole',
    numero: '04',
    titre: 'Dons aux écoles',
    sousTitre: 'Soutenir les écoles & leurs élèves',
    texte: "Des dons de matériel, de fournitures et d'équipements aux écoles : tables-bancs, manuels scolaires, infrastructures (latrines) et produits de première nécessité — un geste concret de solidarité qui change durablement les conditions d'apprentissage des enfants.",
    stats: [
      { valeur: '46', label: 'Photos documentées' },
      { valeur: '1', label: 'École soutenue' }
    ],
    photos: 'donEcole'
  }
]
